...
if (int(data[5]) > 100000000) and (data[12] == 'Amplicon'):
	exit(str(data[0])+": Amplicon, too big!")
...
#Clean up, move
clean = ['rm', rrna_out, blast_out, '3', '2', dataset_id]
result_path = './results/'+dataset_id
